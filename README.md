...
pin are kept in a small front matter block those apps understand. The Share
button sends a copy to Apple Notes; driving Apple Notes directly through Apple
Events was dropped as brittle and permission-heavy. (Google **Keep** is intentionally not used: it has no official
